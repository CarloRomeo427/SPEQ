...
def run():
    ...
    parser.add_argument("-name", type=str, default="utd",
                        help="Run name, default = GroundTruth")
    parser.add_argument('-action_utd', type=int, default=1)
    ...
    path = os.path.join(args.folder, args.env, str(args.seed), args.name, str(args.action_utd))
