...
eval_runs = [f'10K_75K_bias_dropQ_',
             # f'SMC_redq_',
             # f'sac_1_vanilla_',
             # f'vanilla_redQ_300_',
             f'vanilla_dropQ_bias',
             f'utd_9_dropQ_',
             # f'vanilla_redQ_bias',
             # f'utd_9_redQ-',
             # f'sac_1_vanilla_bias',
             f'utd3_bias_drop_',
             f'utd2_bias_drop_',
             ]

# steps_runs = [3_000, 30_000, 2_020_000, 3_000, 401_000, 41_000]
labes = ["SPEQ (Ours)", "DroQ UTD 20", "DroQ UTD 9","DroQ UTD 3","DroQ UTD 2",]# "RedQ UTD 20", "RedQ UTD 9", "SAC UTD 1", ]
...
for run in runs: #and "Ant"  in run.name \
    if run.state == "finished" \
            ...
            and any(substring in run.name for substring in eval_runs):
        print(run.name)
